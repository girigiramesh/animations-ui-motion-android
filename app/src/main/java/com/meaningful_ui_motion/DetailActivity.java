package com.meaningful_ui_motion;
...
/**
 * Created by Hari Prasad on 1/25/17.
 */
public class DetailActivity extends AppCompatActivity {
    public static final String EXTRA_PICTURE = DetailActivity.class.getPackage() + ".extra.PICTURE";
    public static final String EXTRA_TITLE = DetailActivity.class.getPackage() + ".extra.TITLE";
    ...
    public void shareClick(View view) {
        ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(this, mShareButton, getString(R.string.share_transition_name));
